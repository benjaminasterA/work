...
def reviewer_department(state : ChefState): 
    """[검수부서] 완성된 요리 결과물을 최종 확인합니다. """
    st.write(" **[검수부]** 케이크에 딸기가 풍성한지,모양은 예쁜지 최종확인 했습니다. 합격!!")
    #게시판에 제작 완료 메세지를 추가
    return {"messages":["검수부:최종 품질 검사 통과! 손님에게 내보내세요!!!"]}
